...
VL_ATTR_COLD void Vaxi4_top_tb___024root___eval_static__TOP(Vaxi4_top_tb___024root* vlSelf) {
    ...
    vlSelf->axi4_top_tb__DOT__warmup_complete = 0U;
    ...
    vlSelf->axi4_top_tb__DOT__ar_seen = 0U;
    vlSelf->axi4_top_tb__DOT__ar_timeout_counter = 0U;
...
VL_ATTR_COLD void Vaxi4_top_tb___024root___eval_final__TOP(Vaxi4_top_tb___024root* vlSelf) {
    ...
    axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__bins_hit = 0;
    double axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__coverage_pct;
    axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__coverage_pct = 0;
    ...
    __Vfunc_axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__get_bins_hit__0__Vfuncout 
        = __Vfunc_axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__get_bins_hit__0__bins_hit;
    axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__bins_hit 
        = __Vfunc_axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__get_bins_hit__0__Vfuncout;
    axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__coverage_pct 
        = ((100.0 * VL_ISTOR_D_I(32, axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__bins_hit)) 
           / 24.0);
    ...
    VL_WRITEF("  OKAY: %0#, EXOKAY: %0#, SLVERR: %0#, DECERR: %0#\n\nAddress Range Coverage:\n  Region0 (0x000-0x0FF): %0#\n  Region1 (0x100-0x1FF): %0#\n  Region2 (0x200-0x2FF): %0#\n  Region3 (0x300-0x3FF): %0#\n  Out of range (>0x3FF): %0#\n\nWrite Strobe Coverage:\n  Full (4'hF): %0#, Partial: %0#\n\nLAST Signal Coverage:\n  WLAST asserted: %0#, RLAST asserted: %0#\n\n============================================================\nCOVERAGE SUMMARY: %0d/24 bins hit (%.1f%%)\n",
              ...
              32,axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__bins_hit,
              64,axi4_top_tb__DOT__dut__DOT__coverage_monitor__DOT__unnamedblk1__DOT__coverage_pct);
...
VL_ATTR_COLD void Vaxi4_top_tb___024root___ctor_var_reset(Vaxi4_top_tb___024root* vlSelf) {
    ...
    vlSelf->axi4_top_tb__DOT__warmup_complete = VL_RAND_RESET_I(1);
    ...
    vlSelf->axi4_top_tb__DOT__ar_seen = VL_RAND_RESET_I(1);
    vlSelf->axi4_top_tb__DOT__ar_timeout_counter = 0;
