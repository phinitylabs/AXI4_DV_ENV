...
VL_ATTR_COLD void Vaxi4_top_tb___024root___eval_initial__TOP(Vaxi4_top_tb___024root* vlSelf) {
    ...
    axi4_top_tb__DOT__dut__DOT__slave__DOT__unnamedblk1__DOT__i = 0;
    ...
    VL_PRINTF_MT("-Info: verif/axi4_top_tb.sv:593: $dumpvar ignored, as Verilated without --trace\n");
    VL_WRITEF("==========================================\nAXI4 Golden Testbench Started\n==========================================\n");
    axi4_top_tb__DOT__dut__DOT__slave__DOT__unnamedblk1__DOT__i = 0U;
    while (VL_GTS_III(32, 0x100U, axi4_top_tb__DOT__dut__DOT__slave__DOT__unnamedblk1__DOT__i)) {
        vlSelf->axi4_top_tb__DOT__dut__DOT__slave__DOT__memory[(0xffU 
                                                                & axi4_top_tb__DOT__dut__DOT__slave__DOT__unnamedblk1__DOT__i)] = 0U;
        axi4_top_tb__DOT__dut__DOT__slave__DOT__unnamedblk1__DOT__i 
            = ((IData)(1U) + axi4_top_tb__DOT__dut__DOT__slave__DOT__unnamedblk1__DOT__i);
    }
}
