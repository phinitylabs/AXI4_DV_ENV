# =============================================================================
# AXI4 Testbench Generation Benchmark - Makefile
# =============================================================================
...
# Source files - Package MUST come first for correct compilation order
...
grade: $(BUILD_DIR)
	...
	python3 -m pytest $(TESTS_DIR)/test_axi4_tb.py::test_axi4_testbench_generation -v -s
...
# Quick compilation test only
test-compile: $(BUILD_DIR)
	@echo "=== Compilation Test ==="
	python3 -m pytest $(TESTS_DIR)/test_axi4_tb.py::test_tb_compilation_only -v -s
...
quality:
	@echo "=== Quality Check ==="
	python3 $(TESTS_DIR)/quality_checker.py $(TB)
...
# Help
help:
	@echo "AXI4 Testbench Generation Benchmark"
	@echo ""
	@echo "Targets:"
	...
	@echo "  make quality  - Run quality checker on TB"
