// =============================================================================
// MUTANT M03: FIXED Address Changes Bug
// Bug: FIXED burst address increments when it should stay constant
// =============================================================================
      ...
      case (state)
        ...
        DATA_BURST: begin
          if (wvalid && wready) begin
            ...
            case (burst_type)
              // BUG: FIXED burst increments address when it should stay constant
              BURST_FIXED: current_addr <= current_addr + addr_incr;  // BUG!
