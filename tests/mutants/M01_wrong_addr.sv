// Mutant M01: Wrong read address mapping (off by one word)
module axi4_memory
  import axi4_pkg::*;
#(
  ...
  // BUG: Wrong read address - reads from addr+1 instead of addr
  assign rd_mem_addr = rd_addr[MEM_ADDR_WIDTH+1:2] + 1;
