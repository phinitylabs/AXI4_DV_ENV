// =============================================================================
// MUTANT E02: RLAST Early Bug  
// Bug: RLAST asserted one beat early (beat_count == burst_len - 1)
// =============================================================================
...
#(
  ...
  // BUG: RLAST asserted one beat early!
  // Should be: (beat_count == burst_len)
  assign rlast  = (burst_len == 0) ? 1'b1 : (beat_count == burst_len - 1);  // BUG HERE
