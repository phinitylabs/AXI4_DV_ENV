// =============================================================================
// MUTANT E10: BRESP Always OKAY Bug
// Bug: BRESP always returns OKAY, even for decode errors
// =============================================================================
...
#(
  ...
  // BUG: Response logic always returns OKAY, ignoring errors!
  logic [1:0] resp_value;
  always_comb begin
    // BUG: All conditions return RESP_OKAY!
    if (has_decode_error)
      resp_value = RESP_OKAY;  // BUG: Should be RESP_DECERR
    else if (has_wlast_error)
      resp_value = RESP_OKAY;  // BUG: Should be RESP_SLVERR
    else
