// =============================================================================
// MUTANT M01: BID Wrong Bug
// Bug: BID is XOR'd with 0x1, causing mismatch with AWID
// =============================================================================
...
#(
  ...
  // BUG: BID is XOR'd with 1, causing mismatch with original AWID
  assign bid    = txn_id ^ {{(ID_WIDTH-1){1'b0}}, 1'b1};
