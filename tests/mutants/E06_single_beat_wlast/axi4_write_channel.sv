// =============================================================================
// MUTANT E06: Single Beat WLAST Bug
// Bug: WLAST check is skipped for single-beat transactions (awlen=0)
// =============================================================================
...
#(
  ...
  always_comb begin
    ...
    case (state)
      ...
      DATA_BURST: begin
        // BUG: For single-beat (burst_len == 0), doesn't check wlast!
        if (wvalid && wready) begin
          if (burst_len == 0)
            next_state = SEND_RESP;  // BUG: Should still check wlast!
          else if (wlast)
      ...
      case (state)
        ...
        DATA_BURST: begin
          if (wvalid && wready) begin
            ...
            // BUG: WLAST error check skipped for single-beat
            if ((burst_len != 0) && (beat_count == burst_len) && !wlast) begin
