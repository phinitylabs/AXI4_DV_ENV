// MUTANT M05: State Skip Bug
// Bug: Skips directly from IDLE to ACKNOWLEDGED (no PENDING delay)
...
module axi4_interrupt (
    ...
    always_ff @(posedge clk or negedge resetn) begin
        if (!resetn) begin
            ...
            case (next_state)
                ...
                PENDING: interrupt_ack <= 1'b1;  // BUG: Ack in PENDING
    ...
    always_comb begin
        ...
        case (state)
            IDLE: begin
                // BUG: Goes to PENDING but acks immediately
