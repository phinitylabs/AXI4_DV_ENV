// =============================================================================
// MUTANT M02: WRAP Boundary Calculation Bug
// Bug: WRAP burst wraps at wrong boundary (uses fixed 16 instead of calculated)
// =============================================================================
...
#(
  ...
  // BUG: Wrong wrap size - hardcoded to 16 instead of calculated
  logic [ADDR_WIDTH-1:0] wrap_size;
  assign wrap_size = 16;  // BUG: Should be (burst_len + 1) << burst_size
      ...
      case (state)
        IDLE: begin
          if (awvalid && awready) begin
            ...
            wrap_boundary <= (awaddr & ~(wrap_size - 1));  // Uses buggy wrap_size
